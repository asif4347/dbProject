<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="messages.aspx.cs" Inherits="twitter.messages" %>
...
<body>
    ...
    <div id="cent">
     <asp:Button ID="back_to_public" Text="Back to Public Page" runat="server" OnClick="back_public" /><br/>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sqlcon1 %>" SelectCommand="msg_reciever" SelectCommandType="StoredProcedure">
            <SelectParameters>
