<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yourtweets.aspx.cs" Inherits="twitter.yourtweets" %>
...
<body>
    <form id="form1" runat="server">
      <div id="cent">  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sqlcon1 %>" SelectCommand="get_yourtweets" SelectCommandType="StoredProcedure">
            <SelectParameters>
